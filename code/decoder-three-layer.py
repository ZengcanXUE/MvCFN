...
class ConvE(nn.Module):
    def __init__(self, h_dim, out_channels, ker_sz):
        ...
        self.conv = torch.nn.Conv2d(1, out_channels=out_channels, stride=1, padding=3,
                                    kernel_size=ker_sz, bias=False)
        self.conv1 = torch.nn.Conv2d(out_channels, out_channels=out_channels, stride=1, padding=3,
                                    kernel_size=ker_sz, bias=False)
